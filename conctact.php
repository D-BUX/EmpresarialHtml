...
<head>
    ...
    <meta name="description" content="Somos una empresa enfocada en la dirección ejecución y supervisi´n de proyectos que busca el reconocimiento de nuestro trabajo al ofrecer los más altos estándares de calidad con la eficiencia y garantía que
    nuestros clientes se merecen desde nuestro centro de operacones para dar el mejor servicio a la sociedad, atendemos a las instituciones adventistas, gubernamentales y público en general.">
    <meta name="keywords" content="Vernie Architect , Casas, Lima , Ñaña,Acreditacion UPEU,Arquitecto, Leonel Vernie, UPeU ,
     Arquitectura, Peru , Iglesia Adventista del Septimo dia , 
     Templo Villa Unión, Vernie Architect, verniearchitect.com,
    Empresario " />
    <meta name="author" content="Area de desarrollo VerTec">

    <title>Vernie Architect</title>
...
<body>
    ...
    <script>
        (function(d, s, id) {
            ...
            js.id = id;
            js.src = 'https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v3.0&appId=1140634816026733';
							  ...
							  <span class="icon-bar"></span>
                                ...
                                <div class="collapse navbar-collapse navbar-collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li class="dropdown"><a href="#">Acerca de nosotros <b class="caret"></b></a>
                                            <!-- submenu-wrapper -->
                                            <div class="submenu-wrapper submenu-wrapper-topbottom">
                                                <div class="submenu-inner  submenu-inner-topbottom">
                                                    <ul class="dropdown-menu">
                                                        <li><a href="about-us.html">Conocenos</a></li>
                                                        <li><a href="http://leonel.verniearchitect.com">Conoce a Leonel</a></li>
                                                    </ul>
                                                </div>
                                                <!-- /.submenu-inner -->
                                            </div>
                                        ...
                                        <li class="dropdown"><a href="#">Portafolio <b class="caret"></b></a>
                                            <!-- submenu-wrapper -->
                                            <div class="submenu-wrapper submenu-wrapper-topbottom">
                                                <div class="submenu-inner  submenu-inner-topbottom">
                                                    <ul class="dropdown-menu">
                                                        <li><a href="portfolio-three.html">Proyectos</a></li>
                                                    </ul>
                                                </div>
                                                <!-- /.submenu-inner -->
                                            </div>
                                        ...
                                        <li class="dropdown"><a href="#">Trabaja con nosotros <b class="caret"></b></a>
                                            <!-- submenu-wrapper -->
                                            <div class="submenu-wrapper submenu-wrapper-topbottom">
                                                <div class="submenu-inner  submenu-inner-topbottom">
                                                    <ul class="dropdown-menu">
                                                        <li><a href="job-page.html">Area de Trabajo</a></li>
                                                        <li><a href="clients-page.html">Nuestros Clientes</a></li>
                                                    </ul>
                                                </div>
                                                <!-- /.submenu-inner -->
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="active">Vernie Architect</li>
                                    </ol>
                                </div>
                            </div>
                            <!-- /.row -->
                            ...
                            <div class="contact-us-wrapper">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mini-contact">
                                            ...
                                            <a href="mailto:vernie.architect.sac@gmail.com">vernie.architect.sac@gmail.com</a>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mini-contact">
                                            ...
                                            <a href="tel:+51931124300">+51 931 124 300</a>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mini-contact">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mini-contact">
                                            <h2>Visitanos en:</h2>
                                            <address>
											Av. Balaguer Lt. 10A5 Frente Pta. 1 Universidad Peruana Unión <br>
											Ñaña Chosica - Lurigancho - Lima - Lima
										</address>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="directions-wrapper">
                                    <div class="contact-directions">
                                        <h2>Días y hora de atención </h2>
                                        <p> De <strong>Lunes</strong> a <strong>Viernes</strong> </p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <label class="sr-only" for="name">Nombre y apellido</label>
                                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                                    <input id="name" name="name" type="text" class="form-control" required="" placeholder="Nombre y apellido">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input id="email" name="email" type="email" class="form-control" required="" placeholder="exampel@gmail.com">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <label class="sr-only" for="subject">Comentario</label>
                                                    <span class="input-group-addon" id="basic-addon4"><i class="fa fa-file-text"></i></span>
                                                    <input id="subject" name="subject" type="text" class="form-control" required="" placeholder="Sugerencia o Comentario">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="copyright wow fadeInDown">
                                        <p>Copyright &copy; 2018 Vernie Architect . Desarrollado por <a href="http://www.uicookies.com/"><strong> VerTec</strong></a> </p>
                                    </div>
                                    <!-- /.copyright -->
                                </div>
                                <!-- /.col-md-12 -->
    ...
    <script type="text/javascript">
        function initialize() {
            var myLatlng = new google.maps.LatLng(-11.9879923, -76.8387725, 21);
            var mapOptions = {
                zoom: 15,
                scrollwheel: false,
                center: myLatlng,
